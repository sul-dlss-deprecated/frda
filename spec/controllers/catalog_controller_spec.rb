...
describe CatalogController do
  ...
  describe "solr_params_logic" do
    ...
    describe "add_hlfl" do
      it "copies the user's original query to the hl.fl solr parameter" do
        user_params = { "q" => "test" }
        solr_params = {}
        controller.send(:add_hlfl, solr_params, user_params)
        expect(solr_params[:'hl.fl']).to eq user_params["q"]
      end
    end
